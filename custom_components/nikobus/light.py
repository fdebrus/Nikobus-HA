...
async def async_setup_entry(hass: HomeAssistant, entry, async_add_entities) -> bool:
    ...
    for switch_module in data["dimmer_modules_addresses"]: 
        ...
        for i in range(len(channels)):
            ...
            entities.append(NikobusLightEntity(hass, dataservice, description, model, address, i, chDescription))
...
class NikobusLightEntity(CoordinatorEntity, LightEntity):
    ...
    def __init__(self, hass:  HomeAssistant, dataservice, description, model, address, channel, chDescription, initial_state=False, brightness=100) -> None:
    ...
    def is_on(self):
        ...
        self._state = self._dataservice.get_output_state(self._address, self._channel, 10)
        return self._state
