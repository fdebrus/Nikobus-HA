...
class NikobusAPI:
    ...
    async def turn_on_switch(
        ...
        try:
            ...
            _LOGGER.error(f"Failed to turn on switch at address {address}, channel {channel}: {e}")
            raise
    ...
    async def turn_off_switch(
        ...
        try:
            ...
            _LOGGER.error(f"Failed to turn off switch at address {address}, channel {channel}: {e}")
            raise
    ...
    async def turn_on_light(
        ...
        try:
            ...
            _LOGGER.error(f"Failed to turn on light at address {address}, channel {channel}: {e}")
            raise
    ...
    async def turn_off_light(
        ...
        try:
            ...
            _LOGGER.error(f"Failed to turn off light at address {address}, channel {channel}: {e}")
            raise
    ...
    async def stop_cover(
        ...
        try:
            ...
            _LOGGER.error(f"Failed to stop cover at address {address}, channel {channel}: {e}")
            raise
    ...
    async def open_cover(
        ...
        try:
            ...
            _LOGGER.error(f"Failed to open cover at address {address}, channel {channel}: {e}")
            raise
